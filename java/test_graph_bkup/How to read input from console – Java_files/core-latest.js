function dd_load_js(){
	...
	jQuery(document).ready(function($) {
			...
			var fbUrl = "//www.facebook.com/plugins/like.php?href=" + url[0] + "&send=false&layout=box_count&show_faces=false&action=like&colorscheme=light&font=verdana&height=62&width=50";
			...
			var fbPageUrl = "//www.facebook.com/plugins/likebox.php?href=http://www.facebook.com/java.tutorial&width=300&colorscheme=light&show_faces=true&border_color&stream=false&header=false&height=260";
...
if (typeof jQuery == 'undefined') {
	...
	ddscript.src = '//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js';
